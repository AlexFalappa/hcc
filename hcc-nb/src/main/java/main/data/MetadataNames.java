...
public enum MetadataNames {
    ...
    CLOUD_COVER("cloudCoverPercentage"),
    SNOW_COVER("snowCoverPercentage"),
    ...
    INCID_ANGLE_ALONG("alongTrackIncidenceAngle"),
    INCID_ANGLE_ACROSS("acrossTrackIncidenceAngle"),
    ILLUM_ANGLE_AZIM("illuminationAzimuthAngle"),
    ILLUM_ANGLE_ELEV("illuminationElevationAngle"),
    ...
    IMG_DEGRADATION("imageQualityDegradation"),
    BRWSE_FILE_NAME("fileName");
